            ...
            <div>
              ...
              <div className="flex flex-col items-start">
                <input
                  type="text"
                  name="username"
                  className="block pl-3 w-full mt-1 p-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  value={username}
                  onChange={(e) => {
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  ...
                  className="block  w-full mt-1 p-1 pl-3 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  value={c_password}
                  onChange={(e) => {
